...
public class PdfReportWriter4Mnos {
     ...
     */
    public PdfReportWriter4Mnos (PDFReportCreator4Mnos theCreator, boolean custom, int subject, int intervalType, String interval, String month, String year, String subjectName,
    ...
    public boolean createReport(){
        ...
        try {
            ...
            cisPage.setNonStrokingColor(creator.mnos.get(0).colour);    // PDFReportCreator.opcoColours[0]
            cisPage.moveTextPositionByAmount(45, 375);
            //cisPage.drawString("O2 99.92%");
            if (availability[0] > 0) {
                cisPage.drawString(creator.mnos.get(0).alphaId + " " + String.format("%.2f", availability[0]) + "%");
            } else {
                cisPage.drawString(creator.mnos.get(0).alphaId);                
            }
            cisPage.endText();
            
            cisPage.beginText();
            cisPage.setFont(fontCG, 24);
            cisPage.setNonStrokingColor(creator.mnos.get(1).colour);    // PDFReportCreator.opcoColours[1]
            cisPage.moveTextPositionByAmount(45, 340);
            if (availability[1] > 0) {
                cisPage.drawString(creator.mnos.get(1).alphaId + " " + String.format("%.2f", availability[1]) + "%");
            } else {
                cisPage.drawString(creator.mnos.get(1).alphaId);
            }                
            cisPage.endText();

            cisPage.beginText();
            cisPage.setFont(fontCG, 24);
            cisPage.setNonStrokingColor(creator.mnos.get(2).colour);    // PDFReportCreator.opcoColours[2]
            cisPage.moveTextPositionByAmount(45, 305);
            if (availability[2] > 0) {
                cisPage.drawString(creator.mnos.get(2).alphaId + " " + String.format("%.2f", availability[2]) + "%");
            } else {
                cisPage.drawString(creator.mnos.get(2).alphaId);
            }
            cisPage.endText();                

            cisPage.beginText();
            cisPage.setFont(fontCG, 24);
            cisPage.setNonStrokingColor(creator.mnos.get(3).colour);    // PDFReportCreator.opcoColours[3]
            cisPage.moveTextPositionByAmount(45, 270);
            if (availability[3] > 0) {
                cisPage.drawString(creator.mnos.get(3).alphaId + " " + String.format("%.2f", availability[3]) + "%");
            } else {
                cisPage.drawString(creator.mnos.get(3).alphaId);
            }    
            cisPage.endText();                
    ...
    private void addSiteToCustomerReport(PDDocument openCellDocument, String siteName, String siteId) throws Exception {
        ...
        try { 
            ...
            siteCisPage.setNonStrokingColor(creator.mnos.get(0).colour); //  PDFReportCreator.opcoColours[0]
            ...
            if (siteCisValues.get(siteName)[0] > 0) {
                ...
                siteCisPage.drawString(creator.mnos.get(0).alphaId + " " + formattedCIS + "%");
                System.out.println(month + " " + siteName + " CIS " + creator.mnos.get(0).alphaId + " = " + formattedCIS + "%");
            } else {
                siteCisPage.drawString(creator.mnos.get(0).alphaId);                
            }
            siteCisPage.endText();                
            
            siteCisPage.beginText();
            siteCisPage.setFont(fontCG, 24);
            siteCisPage.setNonStrokingColor(creator.mnos.get(1).colour);    // PDFReportCreator.opcoColours[1]
            ...
            if (siteCisValues.get(siteName)[1] > 0) {
                ...
                siteCisPage.drawString(creator.mnos.get(1).alphaId + " " + formattedCIS + "%");
                System.out.println(month + " " + siteName + " CIS " + creator.mnos.get(1).alphaId + " = " + formattedCIS + "%");
            } else {
                siteCisPage.drawString(creator.mnos.get(1).alphaId);
            }                
            siteCisPage.endText();

            siteCisPage.beginText();
            siteCisPage.setFont(fontCG, 24);
            siteCisPage.setNonStrokingColor(creator.mnos.get(2).colour);    // PDFReportCreator.opcoColours[2]
            ...
            if (siteCisValues.get(siteName)[2] > 0) {
                ...
                siteCisPage.drawString(creator.mnos.get(2).alphaId + " " + formattedCIS + "%");
                System.out.println(month + " " + siteName + " CIS " + creator.mnos.get(2).alphaId + " = " + formattedCIS + "%");
            } else {
                siteCisPage.drawString(creator.mnos.get(2).alphaId);
            }
            siteCisPage.endText();                

            siteCisPage.beginText();
            siteCisPage.setFont(fontCG, 24);
            siteCisPage.setNonStrokingColor(creator.mnos.get(3).colour);    // PDFReportCreator.opcoColours[3]
            ...
            if (siteCisValues.get(siteName)[3] > 0) {
                ...
                siteCisPage.drawString(creator.mnos.get(3).alphaId + " " + formattedCIS + "%");
                System.out.println(month + " " + siteName + " CIS " + creator.mnos.get(3).alphaId + " = " + formattedCIS + "%");
            } else {
                siteCisPage.drawString(creator.mnos.get(3).alphaId);
            }    
            siteCisPage.endText();                
